...
\qquad The fuzzy engine contains a set of 64 rules that were defined using an expert's knowledge of
...
\qquad All of the 64 rules are based on the same reasoning as the one that were presented above.
